...
\begin{table}[h]
\centering
\caption{Substrate validation metrics (see App.~\ref{app:substrate-protocol} for definitions). ``Plateau'' refers to the mean residual after subtracting $a_0+a_1\log\ell$ from $\delta\!\langle K\rangle(\ell)$.}
